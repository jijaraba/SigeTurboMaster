        ...
        <nav class="nav-container">
            <ul class="display-horizontal col-100 menu">
                ...
                <li class="col-20 login">
                    <a href="{{ URL::route('login') }}" class="btn btn-green" data-intro="Ingresar a SigeTurbo"
                       data-step="10">
...
<section id="sige_help" class="sige-help-intro fa fa-question-circle"><span>{{ Lang::get('sige.Help') }}</span>
</section>
@yield("vendor")
@yield("angular")
@yield("core")
