                ...
                <section class="sige-observer-new">
                    ...
                    <form ng-submit="observationSave()">
                        <fieldset>
                            <ul class="display-horizontal col-100 student">
                                <li class="col-10 photo">
                                    <div>
                                        <img src="{{ env('ASSETS_SERVER') . "/img/users/" . $student->photo}}" alt="{{ $student->firstname ." ".$student->lastname }}" title="{{ $student->lastname ." ". $student->firstname }}"/>
                                    </div>
                                </li>
                        ...
                        <fieldset>
                            <ul class="display-horizontal col-100">
                                <li class="col-100 gutter-5">
                                    <textarea name="observer" id="observer" ng-model="observer.observer" rows="5" placeholder="Redactar observación"></textarea>
                                </li>
                                <li class="col-100 gutter-5">
                                    <input type="text" name="tags" id="tags" ng-model="observer.tags" placeholder="Etiquetas de Búsqueda">
                                </li>
                                <li class="col-100">
                                    <button type="submit" class="btn btn-aquamarine" ng-disabled="isDisabled">Guardar</button>
                                </li>
                            </ul>
                        </fieldset>
                        ...
                        <input type="hidden" ng-model="observer.student" ng-init="observer.student = '{{ $student->iduser }}'">
                    </form>
                </section>
            </div>
        </section>
