                            ...
                            @foreach($users as $user)
                                ...
                                <li class="col-100">
                                    <ul class="display-horizontal col-100 payment">
                                        ...
                                        <li class="col-45 concept">
                                            <div title="">INFORME PARCIAL TERCER PERIODO ({{ $user->iduser }}
                                                - {{ mb_strtoupper($user->fullname) }})
                                            </div>
                                        </li>
                                        <li class="col-20 generate">
                                            <sige-turbo-report-generate
                                                    student="{{ $user->iduser }}"
                                                    type="partialreport" period="3"></sige-turbo-report-generate>
                                        </li>
                                    </ul>
                                </li>
                            @endforeach
                                        ...
                                        <li class="col-20 generate">
                                            @if(\SigeTurbo\Repositories\Enrollment\EnrollmentRepository::getEnrollmentLatest($user->iduser)->group < 11)
                                                <sige-turbo-report-generate
                                                        ...
                                                        period="1"></sige-turbo-report-generate>
                                            @else
                                                <sige-turbo-report-generate
                                                        student="{{ $user->iduser }}"
                            ...
                            @foreach($users as $user)
                                <li class="col-100">
                                    <ul class="display-horizontal col-100 payment">
                                        ...
                                        <li class="col-45 concept">
                                            <div title="">INFORME FINAL SEGUNDO PERIODO ({{ $user->iduser }}
                                                - {{ mb_strtoupper($user->fullname) }})
                                            </div>
                                        </li>
                                        <li class="col-20 generate">
                                            @if(\SigeTurbo\Repositories\Enrollment\EnrollmentRepository::getEnrollmentLatest($user->iduser)->group < 11)
                                                <sige-turbo-report-generate
                                                        student="{{ $user->iduser }}"
                                                        type="descriptivereport"
                                                        period="2"></sige-turbo-report-generate>
                                            @else
                                                <sige-turbo-report-generate
                                                        student="{{ $user->iduser }}"
                                                        type="finalreport" period="2"></sige-turbo-report-generate>
                                            @endif
                                        </li>
                                    </ul>
                                </li>
                                        ...
                                        <li class="col-20 generate">
                                            @if(\SigeTurbo\Repositories\Enrollment\EnrollmentRepository::getEnrollmentLatest($user->iduser)->group < 11)
                                                <sige-turbo-report-generate
                                                        student="{{ $user->iduser }}"
                                                        type="descriptivereport"
                                                        period="3"></sige-turbo-report-generate>
                                            @else
                                                <sige-turbo-report-generate
                                                        student="{{ $user->iduser }}"
                                                        type="finalreport" period="3"></sige-turbo-report-generate>
                                            @endif
                                        </li>
                                    </ul>
                                </li>
