            ...
            <div class="sige-contained">
                <section class="sige-student-lists" style="margin-top: 40px">
                    ...
                    <section class="search-container">
                        ...
                        <sige-turbo-financials-export year="{{$search['year']}}"></sige-turbo-financials-export>
                    </section>
                    {!! Form::close() !!}
                    ...
                    <section class="student-list">
                        @if($view == 'list')
                            @include('financials.students.partials.list')
                        @elseif($view == 'photo')
                            @include('financials.students.partials.photo')
                        @endif
                    </section>
                    <section class="sige-turbo-pagination-total">
                        <div>{{ Lang::get("sige.Total") . ": " . $students->total() }}</div>
