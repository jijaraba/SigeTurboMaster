        ...
        <li class="col-100">
            <ul class="display-horizontal col-100 student {{ statusList($student->status) }}">
                ...
                <li class="col-10 edit">
                    <a href="{{ URL::route('admissions.students.edit',['student' => $student->iduser, 'year' => $year, 'search' => json_encode($search), 'view' => $view, 'sort' => $sort, 'order' => $order, 'page' => $students->currentPage()]) }}">Edit</a>
                </li>
            </ul>
        </li>
    @endforeach
