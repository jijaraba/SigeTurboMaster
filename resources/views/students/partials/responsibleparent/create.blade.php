{!! Form::open(array('route' => array('admissions.responsibleparents.store'))) !!}
<section class="sige-members">
    <ul id="member-list">
        ...
        <li class="col-30 gutter-5" style="padding: 5%;">
            <input type="text" id="responsible" name="responsible" value="" placeholder="{{ Lang::get('sige.ResponsibleparentNew') }}">
        </li>
