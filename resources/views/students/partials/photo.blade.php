...
@foreach($students as $student)
    ...
    <ul id="student-list-normal">
        <li>
            <a href="{{ URL::route('admissions.students.edit',['student' => $student->iduser, 'year' => $year, 'search' => json_encode($search), 'view' => $view, 'sort' => $sort, 'order' => $order, 'page' => $students->currentPage()]) }}">
