    ...
    <section class="grid-100" ng-controller="StatisticsSubjectController">
        <section class="sige-contained statistics">
            ...
            <section class="sige-statistics">
                <section>
                    <p>Listado de Distribuciones de <strong>Desempeños por Asignatura</strong>. La cantidad de desempeños especificada por cada asignatura corresponde al promedioo obtenido por cada estudiante durante el periodo seleccionado</p>
                    <ul class="display-horizontal">
                        <li data-ng-repeat="subject in subjects" ng-if="subject.datasets[0].data.length > 0" class="subject" style="width: 400px;height:400px">
