...
<head>
    ...
    <title>The New School | {{ Lang::get('sige.PaymentCreatedTitle') }}</title>
                                                            ...
                                                            <article style="width: 100%;margin: 0px auto;">
                                                                ...
                                                                <section>
                                                                    <h2 style="padding-top: 10px;border-bottom: none;text-align: center;color: #8d9aa5;font-size: 2.1em;">
                                                                        {{ money($payment->value2) }}
                                                                    </h2>
                                                                    <p style="padding: 0px;text-align: center;font-size: 0.85em;padding-top: 15px;width: 100%;margin: 0px auto;text-align: center;">{{ $payment->observation2 }}</p>
                                                                    <p style="padding: 0px;text-align: center;font-size: 0.85em;margin: 25px;color: #657380;" class="transaction">
                                                                        <span style="padding: 10px;border-radius: 5px;background: #ed5565;color: white;border-bottom: 3px solid #da4453;"><a style="color:#fff;text-decoration: none" href="{{  env("APP_URL")/parents/payments }}">REALIZAR TU PAGO AHORA</a></span>
                                                                    </p>
                                                                </section>
                                                                <footer style="position: absolute;bottom: 5px;min-height: inherit;top: inherit;width: 100%;">
                                                                    <div style="height: 40px;margin: 10px 20px;padding-top: 15px;border-top: 1px solid #eee;color: #8d9aa5;text-align: center;font-size: 0.8em;">THE NEW SCHOOL</div>
                                                                </footer>
                                                            </article>
                                                        </section>
                                                    </section>
