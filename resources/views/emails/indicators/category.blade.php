...
<head>
    ...
    <title>The New School | {{ Lang::get('sige.AttendancesLevel01') }}</title>
                                                            ...
                                                            <article style="width: 100%;margin: 0px auto;">
                                                                ...
                                                                <section>
                                                                    ...
                                                                    <ul style="width: 95%;display: flex;flex-direction: row;justify-content: flex-start;flex-flow: row wrap;">
                                                                        <li style="width: 100%;flex: auto;float: left;">
                                                                            <p style="padding: 0px;text-align: left;font-size: 0.85em;margin: 0px 25px 25px 25px;color: #657380;">
                                                                                <span>{{ $indicator['teacher'] }}
                                                                                    ingresó el siguiente indicador de categoría {{ $indicator['category'] }}
                                                                                    para el grupo {{ $indicator['group'] }}
                                                                                    en la asigantuta {{ $indicator['subject'] }}
                                                                                    :</span><br>
                                                                                <span style="color:#8d9aa5;">{{ $indicator['indicator'] }}</span><br>
                                                                            </p>
                                                                        </li>
                                                                    </ul>
                                                                </section>
