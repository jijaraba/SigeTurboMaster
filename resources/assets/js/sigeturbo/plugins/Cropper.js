...
const CropperComponent = Vue.extend({
    ...
    mounted() {
        ...
        //const {containerStyle, src, alt, imgStyle } = this.$options.props;
        const props = {};
...
const SigeturboCropper = Vue.component('sigeturbo-cropper', CropperComponent);

export default SigeturboCropper;
