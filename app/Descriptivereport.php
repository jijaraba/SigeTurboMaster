...
class Descriptivereport extends Model
{
    ...
    protected $primaryKey = 'iddescriptivereport';
    protected $fillable = ['idyear', 'idperiod', 'idgroup', 'idsubject', 'idnivel', 'iduser', 'description', 'created_by', 'updated_by'];
    protected $hidden = ['created_at', 'updated_at'];
    /**
     * Table Name
     * @var string
     */
    protected $table = 'descriptivereports';
