...
class MonitoringRepository implements MonitoringRepositoryInterface
{
    ...
    {
        return Monitoring::select(DB::raw("ANY_VALUE(idmonitoringtype) AS idmonitoringtype, ANY_VALUE(idmonitoring) AS idmonitoring,CASE WHEN (rating BETWEEN 0.00 AND 2.99) THEN 'DP' ELSE CASE WHEN (rating BETWEEN 3.00 AND 3.70) THEN 'DB' ELSE CASE WHEN (rating BETWEEN 3.71 AND 4.30) THEN 'DA' ELSE CASE WHEN (rating BETWEEN 4.31 AND 5.00) THEN 'DS' END END END END label, CASE WHEN (rating BETWEEN 0.00 AND 2.99) THEN '#ED5565' ELSE CASE WHEN (rating BETWEEN 3.00 AND 3.70) THEN '#FC6E51' ELSE CASE WHEN (rating BETWEEN 3.71 AND 4.30) THEN '#2f9da3' ELSE CASE WHEN (rating BETWEEN 4.31 AND 5.00) THEN '#A0D468' END END END END color,CASE WHEN (rating BETWEEN 0.00 AND 2.99) THEN '#DA4453' ELSE CASE WHEN (rating BETWEEN 3.00 AND 3.70) THEN '#E9573F' ELSE CASE WHEN (rating BETWEEN 3.71 AND 4.30) THEN '#3ababa' ELSE CASE WHEN (rating BETWEEN 4.31 AND 5.00) THEN '#8CC152' END END END END highlight,COUNT(*) value"))
