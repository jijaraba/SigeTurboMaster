...
INSERT INTO `acls` (`route`, `roles`, `created_at`, `updated_at`) VALUES ('parents.updateinfo.index', 'Admin,Parents', NOW(), NOW());
...
INSERT INTO `acls` (`route`, `roles`, `created_at`, `updated_at`) VALUES ('api.v1.enrollments.getenrollmentslatestbystudentwithcost','Admin,Admission,Counseling,Account,Treasurer,Academic,Principal,Communicator,Discipline,Librarian,Nurse,RRHH,AreaManager,HomeroomTeacher,Teacher,Assistant',NOW(),NOW());
